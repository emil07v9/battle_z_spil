...
function startSpillet() {
  ...
  hekscontainer.classList.add(
    posArray.shift(),
    "hop",
    "delay1",
    "speed" + myRand
  );
  knivmandcontainer.classList.add(
    posArray.shift(),
    "hop",
    "delay2",
    "speed" + myRand
  );
  zombiecontainer1.classList.add(
    posArray.shift(),
    "hop",
    "delay1",
    "speed" + myRand
  );
  zombiecontainer2.classList.add(
    posArray.shift(),
    "hop",
    "delay3",
    "speed" + myRand
...
function stopSpillet() {
  ...
  document
    .querySelector("#time_board_container")
    .removeEventListener("animationend", stopSpillet);

  document
    .querySelector("#heks_container")
    .removeEventListener("animationiteration", badReset);
  document
    .querySelector("#knivmand_container")
    .removeEventListener("animationiteration", badReset);
  document
    .querySelector("#zombie_container1")
    .removeEventListener("animationiteration", goodReset);
  document
    .querySelector("#zombie_container2")
    .removeEventListener("animationiteration", goodReset);
  ...
  document
    ...
    .removeEventListener("animationend", badReset);
  document
    .querySelector("#zombie_sprite1")
    .removeEventListener("animationend", goodReset);
  document
    .querySelector("#zombie_sprite2")
    .removeEventListener("animationend", goodReset);

  document
    .querySelector("#heks_container")
    .removeEventListener("mousedown", klikBadHandler);
  document
    .querySelector("#knivmand_container")
    .removeEventListener("mousedown", klikBadHandler);
  document
    .querySelector("#zombie_container1")
    .removeEventListener("mousedown", klikGoodHandler);
  document
    .querySelector("#zombie_container2")
    .removeEventListener("mousedown", klikGoodHandler);
